...
const {  getOneGroupDetail, getGroupDetails, createGroup, getAddMembersToGroup, simplification, totalOwed, addMembersToGroup, getGroup } = require('./controllers/group');
...
app.get('/api/getExpenseByGroupId', getGroup);
